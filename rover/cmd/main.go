...
func init() {
	...
	utilruntime.Must(roverv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(restConfig, ctrl.Options{
		...
		LeaderElectionID:       "8c7025cc.cp.telekom.com",
	...
	controller.RegisterIndicesOrDie(ctx, mgr)

	if err = (&controller.RoverReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Rover")
		os.Exit(1)
	}

	if err = (&controller.ApiSpecificationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {

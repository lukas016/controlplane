...
func (_m *MockSecretId) Copy() backend.SecretId {
	ret := _m.Called()
...
// MockSecretId_Copy_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Copy'
type MockSecretId_Copy_Call struct {
	*mock.Call
}

// Copy is a helper method to define mock.On call
func (_e *MockSecretId_Expecter) Copy() *MockSecretId_Copy_Call {
	return &MockSecretId_Copy_Call{Call: _e.mock.On("Copy")}
}

func (_c *MockSecretId_Copy_Call) Run(run func()) *MockSecretId_Copy_Call {
...
func (_c *MockSecretId_Copy_Call) Return(_a0 backend.SecretId) *MockSecretId_Copy_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSecretId_Copy_Call) RunAndReturn(run func() backend.SecretId) *MockSecretId_Copy_Call {
	_c.Call.Return(run)
	return _c
}

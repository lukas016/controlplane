...
// OnboardApplication provides a mock function with given fields: ctx, env, teamId, appId, opts
func (_m *MockOnboarder) OnboardApplication(ctx context.Context, env string, teamId string, appId string, opts ...backend.OnboardOption) (backend.OnboardResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, env, teamId, appId)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, ...backend.OnboardOption) (backend.OnboardResponse, error)); ok {
		return rf(ctx, env, teamId, appId, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, ...backend.OnboardOption) backend.OnboardResponse); ok {
		r0 = rf(ctx, env, teamId, appId, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, string, ...backend.OnboardOption) error); ok {
		r1 = rf(ctx, env, teamId, appId, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockOnboarder_Expecter) OnboardApplication(ctx interface{}, env interface{}, teamId interface{}, appId interface{}, opts ...interface{}) *MockOnboarder_OnboardApplication_Call {
	return &MockOnboarder_OnboardApplication_Call{Call: _e.mock.On("OnboardApplication",
		append([]interface{}{ctx, env, teamId, appId}, opts...)...)}
}

func (_c *MockOnboarder_OnboardApplication_Call) Run(run func(ctx context.Context, env string, teamId string, appId string, opts ...backend.OnboardOption)) *MockOnboarder_OnboardApplication_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]backend.OnboardOption, len(args)-4)
...
func (_c *MockOnboarder_OnboardApplication_Call) RunAndReturn(run func(context.Context, string, string, string, ...backend.OnboardOption) (backend.OnboardResponse, error)) *MockOnboarder_OnboardApplication_Call {
	_c.Call.Return(run)
	return _c
}

...
import (
	...
	"github.com/lukas016/controlplane/gateway/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c2be5fef.cp.ei.telekom.de",
	...
	if err = (&controller.ConsumeRouteReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ConsumeRoute")
		os.Exit(1)
	}
